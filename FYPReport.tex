...
Changes in rapid growth of standard deviation is also noteworthy, indicating the instability of the cache misses when the size of the array exceeds 10k.
...
shows better performance than 2-Pivots during runtime tests. They also reported that their 7-Pivot QuickSort has worse performance than the 3-Pivot QuickSort as a result of poor cache behaviors, which is not yet tested in this thesis.
...
although how more predicted branches but less actual branch misses still requires further researches.
