...
Comparably, perf is a more lightweight tool that suits our needs and the given results are more reliable. Previous tests with cachegrind \hyperlink{cachegrindresult}{`} are given in the appendix.
